...
export const Icons = {
  ...
  settings:    (p: IconProps) => <Icon size={p.size} className={p.className} d={['M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z','M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z']} />,
  link:        (p: IconProps) => <Icon size={p.size} className={p.className} d={['M15 7h3a5 5 0 0 1 0 10h-3','M9 17H6A5 5 0 0 1 6 7h3','M8 12h8']} />,
  bell:        (p: IconProps) => <Icon size={p.size} className={p.className} d={['M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9','M13.73 21a2 2 0 0 1-3.46 0']} />,
  users:       (p: IconProps) => <Icon size={p.size} className={p.className} d={['M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2','M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z','M23 21v-2a4 4 0 0 0-3-3.87','M16 3.13a4 4 0 0 1 0 7.75']} />,
  plug:        (p: IconProps) => <Icon size={p.size} className={p.className} d={['M7 22v-5','M17 22v-5','M7 7V2','M17 7V2','M21 7a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5h18z']} />,
  toggleOn:    (p: IconProps) => <Icon size={p.size} className={p.className} d={['M21 12H9','M3 5h18a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2z','M16 12a4 4 0 1 0 8 0 4 4 0 0 0-8 0z']} />,
  qrCode:      (p: IconProps) => <Icon size={p.size} className={p.className} d={['M3 3h7v7H3z','M3 14h7v7H3z','M14 3h7v7h-7z','M14 14h.01','M19 14h.01','M14 19h.01','M19 19h.01','M14 17h2','M17 14v2']} />,
  ...
  eyeOff:      (p: IconProps) => <Icon size={p.size} className={p.className} d={['M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94','M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19','M1 1l22 22','M14.12 14.12a3 3 0 1 1-4.24-4.24']} />,
  moon:        (p: IconProps) => <Icon size={p.size} className={p.className} d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />,
  sun:         (p: IconProps) => <Icon size={p.size} className={p.className} d={['M12 1v2','M12 21v2','M4.22 4.22l1.42 1.42','M18.36 18.36l1.42 1.42','M1 12h2','M21 12h2','M4.22 19.78l1.42-1.42','M18.36 5.64l1.42-1.42','M12 17a5 5 0 1 0 0-10 5 5 0 0 0 0 10z']} />,
  monitor:     (p: IconProps) => <Icon size={p.size} className={p.className} d={['M20 3H4a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2z','M8 21h8','M12 17v4']} />,
  smartphone:  (p: IconProps) => <Icon size={p.size} className={p.className} d={['M17 2H7a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z','M12 18h.01']} />,
  logOut:      (p: IconProps) => <Icon size={p.size} className={p.className} d={['M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4', 'M16 17l5-5-5-5', 'M21 12H9']} />,
